...
if selected == 'Equipo':
    ...
    with col1:
        ...
        st.warning("Somos estudiantes de 5to ciclo de la carrera Ingeniería Ambiental de la Universidad Peruana Cayetano Heredia. Realizamos este proyecto con el entusiasmo de qué otras personas puedan estar informadas sobre la situación actual del Covid-19 en el Perú; asimismo comunicar el impacto que tiene por el número de perdidas humanas por esta enfermedad. Por ello que en la página se muestra algunas tablas y gráficos sobre los datos de fallecidos por Covid-19 del Ministerio de Salud.")
    with col2:
        st.image("ingamb.png")
